...
var BasketPage = /** @class */ (function () {
    function BasketPage(zone, navCtrl, navParams) {
        this.zone = zone;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
...
var SpecialDishPage = /** @class */ (function () {
    function SpecialDishPage(zone, navCtrl, navParams) {
        this.zone = zone;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.isFav = false;
    ...
    SpecialDishPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        var contentHeight = document.getElementsByClassName('bodyScroll')[0].clientHeight;
        var headerHeight = document.getElementsByClassName('bodyHeader')[0].clientHeight;
        var headerStep = headerHeight / 10;
        this.ionScroll.addScrollEventListener(function (event) {
            //  console.log(event);
            console.log(event.srcElement.scrollTop);
            _this.zone.run(function () {
